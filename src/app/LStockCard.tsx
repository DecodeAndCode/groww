...
export function LStockCard({topLoser} : {topLoser : TopLoser}) {
            ...
            <CardContent>
                <div style={{
                    ...
                    <div style={{display: "flex", flexDirection: "column", justifyContent: "center"}}>
                        <Typography align={"center"} variant={"h5"} color={"orange"}>{topLoser.ticker}</Typography>
                    </div>
                </div>
                <div style={{
                    marginLeft: 20
                ...
                <div style={{
                    marginLeft: 20,
                    color: "red"
                }}>{topLoser.change_percentage}</div>
                <div style={{
                    marginLeft: 20,
                    color: "red"
                }}>{topLoser.change_amount}</div>
            </CardContent>
        </CardActionArea>
    </Card>
}